...
def unfollow(username):
    ...
    if not current_user.is_following(user):
        flash('You are not following this user %s.' % username)
        return redirect(url_for('.user', username=username))
    current_user.unfollow(user)
    flash('You unfollow this user %s.' % username)
    return redirect(url_for('.user', username=username))
...
def followed_by(username):
    ...
    return render_template('followers.html', user=user, title="Follower by",
                           endpoint='.followed_by', pagination=pagination, follows=followed)
