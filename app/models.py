...
class User(UserMixin, db.Model):
    ...
    def followed_posts(self):
        return Post.query.join(Follow, Follow.followed_id == Post.auther_id).filter(Follow.follower_id == self.id)
...
class Post(db.Model):
    ...
    def to_json(self):
        json_post = {
            ...
            'author': url_for('api.get_user', id=self.auther_id, _external=True),
...
class Comment(db.Model):
    ...
    def on_changed_body(target, value, oldvalue, initiator):
        ...
        target.body_html = bleach.linkify(bleach.clean(markdown(value, outout_format='html'),
                                                       tags=allowed_tags, strip=True))
    ...
    def to_json(self):
        json_post = {
            ...
            'posts': url_for('api.get_posts', id=self.post_id, _external=True)
        }
        return json_post
